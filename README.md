...
The key that will hide or show the Grassward Compass. Here is a list of all the valid key names:
...
Set this to `true` if you'd like to use the heuristic, otherwise leave it set to `false` to use the big list.

### AutomaticallyCutGrass

Set this to `true` to have the mod automatically slash uncut grass for you.
